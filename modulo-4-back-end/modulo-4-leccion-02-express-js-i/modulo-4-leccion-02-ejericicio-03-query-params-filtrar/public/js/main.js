...
document.querySelector(".js-btn-get-users").addEventListener("click", () => {
  ...
  const inputFilterByEmail = document.querySelector(".js-input-filterByEmail");

  const queryParams = `?filterByName=${inputFilterByName.value}&filterByEmail=${inputFilterByEmail.value}`;
