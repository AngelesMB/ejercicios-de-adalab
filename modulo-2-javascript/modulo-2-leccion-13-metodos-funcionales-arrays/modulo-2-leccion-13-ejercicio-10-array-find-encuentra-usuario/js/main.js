...
const selectedPin = users.find((user) => user.pin === 5232);

console.log(selectedPin.name);

const selectedPinIndex = users.findIndex((user) => user.pin === 5232);

console.log(selectedPinIndex);

users.splice(selectedPinIndex, 1);
